...
export const CustomerSchema = z.object({
	...
	address: z.string()
		...
		.refine(value => value && value.length <= 100, 'Customer address must not be more than 100 characters.')
		.optional()
});
...
export const BusinessSchema = z.object({
	...
	address: z.string()
		...
		.refine(value => value && value.length <= 200, 'Business address must not be more than 200 characters.')
		.optional()
});
