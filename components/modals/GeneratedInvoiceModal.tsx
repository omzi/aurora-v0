...
function GeneratedInvoiceModal({controller, onOpenChange, invoiceLink}: GenerateProps) {
          ...
          <DialogContent>
            <DialogHeader className='border-b pb-3'>
              <h2 className='text-lg font-medium'>Success 🎉</h2>
                ...
                <div className='font-semibold text-center text-[1rem]'>Invoice has been generated</div>
