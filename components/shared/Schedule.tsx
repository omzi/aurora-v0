  ...
  return (
    <section className='grid gap-5 grid-cols-1 lg:grid-cols-2'>
			<div className='flex flex-col items-start gap-3 px-5'>
				...
				<p className='text-xl text-left mt-5'>Expand your customer base, streamline invoicing, and effortlessly manage payments and withdrawals with Aurora – your trusted tech partner in payment solutions.</p>
